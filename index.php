 ...
 <body onLoad="peta_awal()">
         ...
         <div class="container-fluid">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul id="form_lokasi" class="navbar-nav me-auto mb-4 mb-lg-0">
                     ...
                     <li class="nav-item">
                         <input class="form-control me-2" type="text" name="koordinatx" id="koorX" readonly="readonly" placeholder="Kordinat X">
                     </li>

                     <li class="nav-item">
                         <input class="form-control me-2" type="text" name="koordinaty" id="koorY" readonly="readonly" placeholder="Kordinat Y">
                     </li>
                     <li class="nav-item">
                         <input class="form-control me-2" type="text" name="namatempat" id="namaTempat" placeholder="Nama Tempat">
                     </li>
                     <li class="nav-item">
                 ...
                 <form id="form" method="POST" role="search" name="country">
                     <div id="suggest" class="d-flex flex-row">
                         <input class="form-control me-2" placeholder="Pilih Negara" aria-label="Search" type="text" value="" id="country" onblur="fill();" onkeyup="suggest(this.value);">
                     </div>
                     <div class="suggestionsBox" id="suggestions" style="display: none; text-decoration: none;"> <img src="arrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
     ...
     <div id="kanvaspeta" style="margin:10px; width:100%; height:630px; padding:10px;">
     </div>
             ...
             <div class="col-12">
                 <?php
                    if (isset($_SESSION['login']) && $_SESSION['login'] === true) {
                        ...
                        echo "<h2> Data Lokasi Tersimpan : </h2>";
